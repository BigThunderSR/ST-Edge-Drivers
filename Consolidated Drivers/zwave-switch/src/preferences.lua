...
local GE_SCENE = {
  PARAMETERS = {
    ...
    ledLightInten   = {type = 'config', parameter_number = 35, size = 1},
    guideLightInten = {type = 'config', parameter_number = 36, size = 1},
...
local devices = {
  ...
  GE_SWITCH_SCENE = {
    MATCHING_MATRIX = {
      ...
      product_ids = {0x3135, 0x3136, 0x3137, 0x3138, 0x3139, 0x3231, 0x3237, 0x3238, 0x3239, 0x3330, 0x3331, 0x3333, 0x3334},
    },
  ...
  GE_DIMMER_SCENE = {
    MATCHING_MATRIX = {
      mfrs = {0x0039, 0x0063},
      product_types = {0x4944},
      product_ids = {0x3132, 0x3235, 0x3237, 0x3333, 0x3334, 0x3339, 0x3430, 0x3431, 0x3433},
    },
    PARAMETERS = GE_SCENE.PARAMETERS,
    BUTTONS = GE_SCENE.BUTTONS,
  },
